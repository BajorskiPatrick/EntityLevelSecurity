...
public class AclConnectionProxy implements Connection {
    ...
    public AclConnectionProxy(Connection delegate) {
    ...
    public PreparedStatement prepareStatement(String sql, int resultSetType, int resultSetConcurrency) throws SQLException {
        if(AclContext.isActive()){
            String newSql = rewriter.addAclToSql(sql, AclContext.getCurrentUser());
            logger.log("Rewritten SQL: " + newSql);
            return delegate.prepareStatement(newSql, resultSetType, resultSetConcurrency);
        }
    ...
    public PreparedStatement prepareStatement(String sql, int resultSetType, int resultSetConcurrency, int resultSetHoldability) throws SQLException {
        if(AclContext.isActive()){
            String newSql = rewriter.addAclToSql(sql, AclContext.getCurrentUser());
            logger.log("Rewritten SQL: " + newSql);
            return delegate.prepareStatement(newSql, resultSetType, resultSetConcurrency, resultSetHoldability);
        }
    ...
    public PreparedStatement prepareStatement(String sql, int autoGeneratedKeys) throws SQLException {
        if(AclContext.isActive()){
            String newSql = rewriter.addAclToSql(sql, AclContext.getCurrentUser());
            logger.log("Rewritten SQL: " + newSql);
            return delegate.prepareStatement(newSql, autoGeneratedKeys);
        }
    ...
    public PreparedStatement prepareStatement(String sql, int[] columnIndexes) throws SQLException {
        if(AclContext.isActive()){
            String newSql = rewriter.addAclToSql(sql, AclContext.getCurrentUser());
            logger.log("Rewritten SQL: " + newSql);
            return delegate.prepareStatement(newSql, columnIndexes);
        }
